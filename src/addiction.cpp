    ...
    switch( add.type ) {
        ...
        case ADD_OPIATES:
            ...
            if( one_in( 20 ) && dice( 2, 20 ) < in ) {
                ...
                u.add_morale( MORALE_CRAVING_OPIATES, -40, -10 * in );
                ...
                u.add_morale( MORALE_CRAVING_OPIATES, -30, -10 * in );
            } else if( one_in( 50 ) && dice( 3, 50 ) < in ) {
                u.vomit();
            }
            break;

        case ADD_AMPHETAMINE: {
            u.mod_int_bonus( -1 );
            u.mod_str_bonus( -1 );
            ...
            if( dice( 2, 100 ) < in ) {
                ...
                u.add_morale( MORALE_CRAVING_AMPHETAMINE, -25, -20 * in );
        ...
        case ADD_CRACK: {
            ...
            const std::string &cur_msg = add.type == ADD_COCAINE ? coke_msg : crack_msg;
            const auto morale_type = add.type == ADD_COCAINE ? MORALE_CRAVING_COCAINE : MORALE_CRAVING_CRACK;
            u.mod_int_bonus( -1 );
            u.mod_per_bonus( -1 );
            if( one_in( 900 - 30 * in ) ) {
...
const std::string &addiction_type_name( add_type const cur )
{
    static const std::map<add_type, std::string> type_map = {{
            { ADD_NICOTINE, _( "nicotine" ) },
            { ADD_CAFFEINE, _( "caffeine" ) },
            { ADD_ALCOHOL, _( "alcohol" ) },
            { ADD_SLEEPING_PILLS, _( "sleeping pills" ) },
            { ADD_OPIATES, _( "opiates" ) },
            { ADD_AMPHETAMINE, _( "amphetamine" ) },
            { ADD_COCAINE, _( "cocaine" ) },
            { ADD_CRACK, _( "crack cocaine" ) },
            { ADD_MUTAGEN, _( "mutagen" ) },
            { ADD_DIAZEPAM, _( "diazepam" ) },
            { ADD_MARLOSS_RED, _( "Marloss berries" ) },
            { ADD_MARLOSS_BLUE, _( "Marloss seeds" ) },
            { ADD_MARLOSS_YELLOW, _( "Marloss gel" ) },
        }
    };
...
{
    static const std::map<add_type, std::string> type_map = {{
            { ADD_NICOTINE, _( "Nicotine Withdrawal" ) },
            { ADD_CAFFEINE, _( "Caffeine Withdrawal" ) },
            { ADD_ALCOHOL, _( "Alcohol Withdrawal" ) },
            { ADD_SLEEPING_PILLS, _( "Sleeping Pill Dependence" ) },
            { ADD_OPIATES, _( "Opiate Withdrawal" ) },
            { ADD_AMPHETAMINE, _( "Amphetamine Withdrawal" ) },
            { ADD_COCAINE, _( "Cocaine Withdrawal" ) },
            { ADD_CRACK, _( "Crack Cocaine Withdrawal" ) },
            { ADD_MUTAGEN, _( "Mutation Withdrawal" ) },
            { ADD_DIAZEPAM, _( "Diazepam Withdrawal" ) },
            { ADD_MARLOSS_RED, _( "Marloss Longing" ) },
            { ADD_MARLOSS_BLUE, _( "Marloss Desire" ) },
            { ADD_MARLOSS_YELLOW, _( "Marloss Cravings" ) },
        }
    };
...
morale_type addiction_craving( add_type const cur )
{
    static const std::map<add_type, morale_type> type_map = {{
            { ADD_NICOTINE, MORALE_CRAVING_NICOTINE },
            { ADD_CAFFEINE, MORALE_CRAVING_CAFFEINE },
            { ADD_ALCOHOL, MORALE_CRAVING_ALCOHOL },
            { ADD_OPIATES, MORALE_CRAVING_OPIATES },
            { ADD_AMPHETAMINE, MORALE_CRAVING_AMPHETAMINE },
            { ADD_COCAINE, MORALE_CRAVING_COCAINE },
            { ADD_CRACK, MORALE_CRAVING_CRACK },
            { ADD_MUTAGEN, MORALE_CRAVING_MUTAGEN },
            { ADD_DIAZEPAM, MORALE_CRAVING_DIAZEPAM },
            { ADD_MARLOSS_RED, MORALE_CRAVING_MARLOSS },
            { ADD_MARLOSS_BLUE, MORALE_CRAVING_MARLOSS },
            { ADD_MARLOSS_YELLOW, MORALE_CRAVING_MARLOSS },
        }
    };
...
add_type addiction_type( const std::string &name )
{
    static const std::map<std::string, add_type> type_map = {{
            { "nicotine", ADD_NICOTINE },
            { "caffeine", ADD_CAFFEINE },
            { "alcohol", ADD_ALCOHOL },
            { "sleeping pill", ADD_SLEEPING_PILLS },
            { "opiate", ADD_OPIATES },
            { "amphetamine", ADD_AMPHETAMINE },
            { "cocaine", ADD_COCAINE },
            { "crack", ADD_CRACK },
            { "mutagen", ADD_MUTAGEN },
            { "diazepam", ADD_DIAZEPAM },
            { "marloss_red", ADD_MARLOSS_RED },
            { "marloss_blue", ADD_MARLOSS_BLUE },
            { "marloss_yellow", ADD_MARLOSS_YELLOW },
            { "none", ADD_NULL }
        }
    };
...
const std::string &addiction_text( const addiction &cur )
{
    static const std::map<add_type, std::string> addiction_msg = {{
            { ADD_NICOTINE, _( "Intelligence - 1;   Occasional cravings" ) },
            ...
            { ADD_SLEEPING_PILLS, _( "You may find it difficult to sleep without medication." ) },
            {
                ADD_OPIATES, _( "Strength - 1;   Perception - 1;   Dexterity - 1;\nDepression and physical pain to some degree.  Frequent cravings.  Vomiting." )
            },
            { ADD_AMPHETAMINE, _( "Strength - 1;   Intelligence - 1;\nMovement rate reduction.  Depression.  Weak immune system.  Frequent cravings." ) },
            { ADD_COCAINE, _( "Perception - 1;   Intelligence - 1;  Frequent cravings." ) },
            ...
            { ADD_MARLOSS_RED, _( "You should try some of those pink berries." ) },
            { ADD_MARLOSS_BLUE, _( "You should try some of those cyan seeds." ) },
            { ADD_MARLOSS_YELLOW, _( "You should try some of that golden gel." ) },
        }
    };
