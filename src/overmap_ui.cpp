...
cata::optional<railroad_station> ui::omap::select_railroad_station( uilist &railroad_stations_menu,
        std::vector<railroad_station> &railroad_stations_container, bool random )
{
    cata::optional<railroad_station> ret_val = cata::nullopt;
    if( random ) {
        ret_val = random_entry( railroad_stations_container );
    } else {
        railroad_stations_menu.show();
