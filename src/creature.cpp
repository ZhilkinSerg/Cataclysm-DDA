                                       ...
                                       bool print_messages )
{
    ...
    if( proj.proj_effects.count( "FLAME" ) ) {
        if( made_of_any( materials::get_plant() ) || made_of_any( materials::get_flammable() ) ) {
            add_effect( effect_onfire, rng( 8_turns, 20_turns ), bp_hit );
        } else if( made_of_any( materials::get_flesh() ) ) {
        ...
        } else if( made_of_any( materials::get_flesh() ) && one_in( 4 ) ) {
